...
int main(int argc, char**argv )
{
    ...
    double mean_u = mean(_range=elements(mesh),_expr=idv(u))(0,0);
    double mean_g = mean(_range=elements(mesh),_expr=idv(v))(0,0);
    // end::forms[]
    cout << "||u-u_h||_L2="
         << normL2(_range=elements(mesh), _expr=(idv(u)-mean_u)-(g-mean_g)) << std::endl;
